              ...
              <div className="absolute inset-0 opacity-30">
                <div className="h-full w-full bg-gradient-to-br from-blue-900/50 to-purple-900/50">
                  <div className="absolute top-4 left-4 text-green-300 text-xs font-mono opacity-60">
                    ...
                    <div className="ml-4">
                      return collaboration + creativity;
                    </div>
                  </div>
              ...
              <div className="relative p-8 flex items-center justify-between">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="bg-white text-gray-700 px-6 py-2 rounded-lg font-medium flex items-center space-x-2 hover:bg-gray-50 transition-colors"
                  >
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    A Hobby Club is a group or community where people with
                    shared interests come together to explore, practice, and
                    enjoy their hobbies. It’s common in colleges, schools, and
                    workplaces as an extracurricular or co-curricular activity.
                  </p>
                  <h3 className="text-red-500 mt-4">
                    🎯 Purpose of a Hobby Club
                  </h3>
                  ...
                  <ul className="mt-2 space-y-2 list-none">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Provide a platform for members to pursue interests
                        outside academics/work.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-1 inline-flex h-3 w-3 rounded-full bg-pink-500" />
                      <span>
                        Encourage creativity, innovation, and teamwork.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-1 inline-flex h-3 w-3 rounded-full bg-amber-400" />
                      <span>
                        Offer relaxation and stress relief through engaging
                        activities.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Help in personality development and skill-building.
                      </span>
                    </li>
                  </ul>
                </div>
